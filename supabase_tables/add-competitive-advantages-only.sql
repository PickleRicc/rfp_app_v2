-- Add Competitive Advantages to Existing Company
-- Run this AFTER creating the competitive_advantages table
-- This adds sample ghosting phrases to your existing TechVision company

-- First, get the company_id (replace with your actual company ID if different)
DO $$
DECLARE
    v_company_id UUID;
BEGIN
    ...
    IF v_company_id IS NULL THEN
        RAISE EXCEPTION 'Company not found. Please check company_name in company_profiles table.';
    END IF;
